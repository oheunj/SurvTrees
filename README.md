...
The source code is currently provided in 'github_example.R' which loads R packages and 'fit_models.R' for model development and 'eval_models.R' for model evaluation.
